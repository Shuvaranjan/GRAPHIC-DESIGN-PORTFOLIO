...
contactForm.addEventListener("submit", function (event) {
  ...
  if (
    ...
    (user_name.value.trim() == "" && user_message.value.trim() == "") ||
    (user_name.value.trim() == "" && gmailInput.value.trim() == "") ||
    (gmailInput.value.trim() == "" && user_message.value.trim() == "")
  ) {
...
sReveal.reveal(
  ".projects_card, .services_card, .experiance_card, .section-title",
  { interval: 100 },
);
...
document
  ...
  .addKeyListener("keydown", function (event) {
